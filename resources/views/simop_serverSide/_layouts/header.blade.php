    ...
    <header class="top-header">
      <nav class="navbar navbar-expand gap-3">
       ...
       <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown"><img src="{{asset('template_serverSide/assets/images/county/02.png')}}" width="22" alt="">
        </a>
        <ul class="dropdown-menu dropdown-menu-end p-2">
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/01.png')}}" width="20" alt=""><span class="ms-2">English</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/02.png')}}" width="20" alt=""><span class="ms-2">Catalan</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/03.png')}}" width="20" alt=""><span class="ms-2">French</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/04.png')}}" width="20" alt=""><span class="ms-2">Belize</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/05.png')}}" width="20" alt=""><span class="ms-2">Colombia</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/06.png')}}" width="20" alt=""><span class="ms-2">Spanish</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/07.png')}}" width="20" alt=""><span class="ms-2">Georgian</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{asset('template_serverSide/assets/images/county/08.png')}}" width="20" alt=""><span class="ms-2">Hindi</span></a>
          </li>
        </ul>
      </li>
                 ...
                 <div class="row row-cols-3 gx-2">
                    ...
                    <div class="col">
                      ...
                      <div class="apps p-2 radius-10 text-center">
                         ...
                         <p class="mb-0 apps-name">Usuários</p>
                      </div>
                    </a>
                   </div>
                   <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Produtos</p>
                    </div>
                    </a>
                  </div>
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Pedidos</p>
                    </div>
                    </a>
                  </div>
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Minha Conta</p>
                     </div>
                    </a>
                  </div>
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Chat Box</p>
                    </div>
                    </a>
                  </div>
                  <div class="col">
                    <a href="/products/orders/detail">
                    <div class="apps p-2 radius-10 text-center">
                       <div class="apps-icon-box mb-1 text-white bg-gradient-branding">
                        <i class="bi bi-credit-card-fill"></i>
                       </div>
                       <p class="mb-0 apps-name">Vendas</p>
                    </div>
                    </a>
                  </div>
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Eventos</p>
                    </div>
                  </a>
                  </div>
                  <div class="col">
                    ...
                    <div class="apps p-2 radius-10 text-center">
                       ...
                       <p class="mb-0 apps-name">Histórico</p>
                      </div>
                    </a>
                  </div>
                 </div><!--end row-->
               ...
               <div class="header-message-list p-2">
                   <a class="dropdown-item" href="#">
                     <div class="d-flex align-items-center">
                        <img src="{{asset('template_serverSide/assets/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="50" height="50">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="{{asset('template_serverSide/assets/images/avatars/avatar-2.png')}}" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="{{asset('template_serverSide/assets/images/avatars/avatar-3.png')}}" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="{{asset('template_serverSide/assets/images/avatars/avatar-4.png')}}" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="{{asset('template_serverSide/assets/images/avatars/avatar-5.png')}}" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="{{asset('template_serverSide/assets/images/avatars/avatar-6.png')}}" alt="" class="rounded-circle" width="50" height="50">
                       <div class="ms-3 flex-grow-1">
            ...
            <div class="dropdown dropdown-user-setting">
              <a class="dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                <div class="user-setting d-flex align-items-center gap-3">
                  <img src="{{asset('template_serverSide/assets/images/avatars/avatar-1.png')}}" class="user-img" alt="">
                  <div class="d-none d-sm-block">
                     <p class="user-name mb-0">Fernão Massalane</p>
                    <small class="mb-0 dropdown-user-designation">Admin & CO - Dimark</small>
                  </div>
                </div>
              </a>
