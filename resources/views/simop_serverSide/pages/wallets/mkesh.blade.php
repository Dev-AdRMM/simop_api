...
<script src="{{ asset('/js/Server_Side/Supplier/Status.ajax.js') }}"></script>
       ...
       <!--start content-->
          <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Carteira</div>
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Mkesh</li>
                  </ol>
                </nav>
              </div>
              <div class="ms-auto">
                <div class="btn-group">
                  <button type="button" class="btn btn-primary">Opções de Mkesh</button>
                  <button type="button" class="btn btn-primary split-bg-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">	<span class="visually-hidden">Toggle Dropdown</span>
                  </button>
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                    <a class="dropdown-item" href="javascript:;">Nova Carteira Mkesh</a>
                    <a class="dropdown-item" href="javascript:;">Ver Carteiras Mkesh</a>
                     <a class="dropdown-item" href="javascript:;">Gerar Carteiras de Produção</a>
                  </div>
                </div>
              </div>
            </div>
