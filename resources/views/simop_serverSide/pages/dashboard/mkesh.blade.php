        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2 row-cols-xxl-4">
            ...
            <div class="col">
                <div class="card overflow-hidden rounded-4">
                    <div class="card-body p-2">
                        <div
                            class="d-flex align-items-stretch justify-content-between rounded-4 overflow-hidden bg-success">
                            <div class="w-50 p-3">
                ...
                <div class="card rounded-4 overflow-hidden w-100">
                    ...
                    <ul class="list-group list-group-flush">
                        <li
                            ...
                            <i class="bi bi-tablet-landscape-fill me-2 text-orange"></i> <span>Tablet - </span>
                            <span>22.5%</span>
                        </li>
                    ...
                    <div class="card-body p-0">
                        <div class="best-product p-2 mb-3">
                            ...
                            <div class="best-product-item">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{asset('template_serverSide/assets/images/products/06.png')}}" alt="">
                                    </div>
                                    <div class="product-info flex-grow-1">
                                        <div class="progress-wrapper">
                                            <div class="progress" style="height: 5px;">
                            ...
                            <div class="best-product-item">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{asset('template_serverSide/assets/images/products/07.png')}}" alt="">
                                    </div>
                                    <div class="product-info flex-grow-1">
                                        <div class="progress-wrapper">
                                            <div class="progress" style="height: 5px;">
                            ...
                            <div class="best-product-item">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{asset('template_serverSide/assets/images/products/08.png')}}" alt="">
                                    </div>
                                    <div class="product-info flex-grow-1">
                                        <div class="progress-wrapper">
                                            <div class="progress" style="height: 5px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="product-box border">
                                            <img src="{{asset('template_serverSide/assets/images/products/11.png')}}" alt="">
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="product-box border">
                                            <img src="{{asset('template_serverSide/assets/images/products/17.png')}}" alt="">
                                        </div>
                                        <div class="product-info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="product-box border">
                                            <img src="{{asset('template_serverSide/assets/images/products/10.png')}}" alt="">
                                        </div>
                                        <div class="product-info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="product-box border">
                                            <img src="{{asset('template_serverSide/assets/images/products/12.png')}}" alt="">
                                        </div>
                                        <div class="product-info">
